  ...
  return (
    <>
      <div className="relative">
        <header
          className={`relative flex flex-col items-center ${service.bgImage} h-[22.5rem] lg:h-[25.5rem] xl:h-[25.5rem] bg-cover bg-center bg-no-repeat px-8 py-24 lg:px-20 2xl:px-40`}
        >
